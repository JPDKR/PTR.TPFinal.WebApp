...
namespace PTR.TPFinal.Domain.Migrations
{
    ...
    [Migration("20250829193901_Various")]
    partial class Various
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTR.TPFinal.Domain.Models.ShoppingCart", b =>
                {
                    b.HasOne("PTR.TPFinal.Domain.Models.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PTR.TPFinal.Domain.Models.Employee", "Employee")
                        .WithMany()
